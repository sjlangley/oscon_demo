<?php
/**
 * Generated by the Google APIs Client Generator
 * https://code.google.com/p/google-apis-client-generator/
 * Slight modification to handle "additionalParams" in the json schema line #360
 *
 * @copyright 2013 Google Inc. All rights reserved.
 * @author Brian Lynch <lynchb@google.com>
 */
 ...
 */
  ...
  class Google_DatasetsServiceResource extends Google_ServiceResource {
    ...
    /**
     * Write a mutation outside of a transaction. (datasets.blindWrite)
     *
     * @param string $datasetId Identifies the dataset.
    ...
    /**
     * Commit a transaction. (datasets.commit)
     *
     * @param string $datasetId Identifies the dataset.
    ...
    /**
     * Lookup entities. (datasets.lookup)
     *
     * @param string $datasetId Identifies the dataset.
    ...
    /**
     * Rollback a transaction. (datasets.rollback)
     *
     * @param string $datasetId Identifies the dataset.
